                    ...
                    <AnimatePresence>
                      {isServicesOpen && (
                        <motion.div
                          ...
                          className="absolute top-full left-0 w-48 bg-white shadow-lg rounded-xl py-2 border border-gray-100 origin-top">
                ...
                if (link.subLinks) {
                  return (
                    <motion.div key={idx} variants={mobileItemsVariants}>
                      ...
                      <div className="pl-4 space-y-2 border-l-2 border-blue-100 ml-2 mt-1">
                        {link.subLinks.map((sub, subIdx) => (
                          <Link
                            key={subIdx}
                            href={sub.href}
