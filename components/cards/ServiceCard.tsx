...
export default function ServiceCard({
    ...
    return (
        <motion.div
            ...
            className="bg-white/[0.03] backdrop-blur-md border border-white/10 rounded-2xl p-7 flex flex-col justify-between transition-colors duration-300 hover:bg-white/[0.06] hover:border-blue-500/40 hover:shadow-[0_8px_30px_rgba(0,87,238,0.15)] group h-full relative overflow-hidden">
