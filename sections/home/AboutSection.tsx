...
export default function AboutSection() {
    ...
    return (
        <section className="relative w-full overflow-hidden bg-gradient-to-br from-white via-blue-50/40 to-white py-16 sm:py-20 lg:py-24">
            {/* Background Graphics */}
            ...
            <div className="relative z-10 max-w-[1400px] mx-auto px-4 sm:px-6 lg:px-8 w-full">
                <div className="grid grid-cols-1 items-center gap-12 lg:gap-16 lg:grid-cols-2">
                    ...
                    <motion.div
                        ...
                        <div className="grid grid-cols-2 gap-x-6 gap-y-8 sm:grid-cols-4 ">
                            {data.features.map((feature) => {
                                ...
                                return (
                                    <div key={feature.title} className="w-full space-y-3">
                                        <div className="flex h-20 w-20 items-center justify-center rounded-full bg-blue-50 text-blue-600 mx-auto sm:mx-0">
                                            <IconComp size={32} strokeWidth={1.75} />
                                        </div>
                                        <h3 className="text-base sm:text-lg font-bold text-slate-900 text-center sm:text-left">
                                            {feature.title}
                                        </h3>
                                        <p className="text-sm leading-relaxed text-slate-500 text-center sm:text-left">
                                            {feature.description}
                                        </p>
                                    </div>
                                );
                    ...
                    <motion.div
                        ...
                        <div className="relative w-full max-w-lg lg:max-w-[580px] xl:max-w-[420px]">
                            ...
                            {/* image card */}
                            <div className="relative h-[480px] sm:h-[540px] lg:h-[580px] w-full overflow-hidden rounded-tl-[200px] rounded-bl-[200px] rounded-tr-3xl rounded-br-3xl border-tl-4 border-white shadow-2xl z-10">
                                <Image
                                    src={data.image.src}
                                    alt={data.image.alt}
                                    fill
